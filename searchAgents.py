...
def optimalPathWithoutWalls(fromPos, throughPoints):
    ...
    while points != []:
        index, dist = distanceArgim(pos, points)
        pathLength += dist
        pos = points[index]
        points.pop(index)
...
def cornersHeuristic(state, problem):
    ...
    "*** YOUR CODE HERE ***"
    return optimalPathWithoutWalls(*state) # Default to trivial solution
...
##def mimimumSpanningTreeTotalWeight(adjM):
...
def foodAdjMatrixAfterEating(problem, foodLeft):
    foodList = problem.heuristicInfo['initalFood']
...
def foodHeuristic(state, problem):
    ...
    #mstTotalW = mimimumSpanningTreeTotalWeight(adjM)
